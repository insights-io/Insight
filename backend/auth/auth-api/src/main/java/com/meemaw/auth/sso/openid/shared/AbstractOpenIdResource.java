...
@Slf4j
public abstract class AbstractOpenIdResource<T, U extends OAuthUserInfo, E extends OAuthError>
    implements OpenIdResource {
  ...
  public Response signIn(AbstractOpenIdService<T, U, E> oauthService, String destination) {
  ...
  public CompletionStage<Response> oauth2callback(
      AbstractOpenIdService<T, U, E> oauthService, String state, String sessionState, String code) {
