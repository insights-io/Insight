...
import static com.rebrowse.auth.password.datasource.sql.SqlPasswordTable.CREATED_AT;
import static com.rebrowse.auth.password.datasource.sql.SqlPasswordTable.HASH;
import static com.rebrowse.auth.password.datasource.sql.SqlPasswordTable.TABLE;
import static com.rebrowse.auth.password.datasource.sql.SqlPasswordTable.USER_ID;
