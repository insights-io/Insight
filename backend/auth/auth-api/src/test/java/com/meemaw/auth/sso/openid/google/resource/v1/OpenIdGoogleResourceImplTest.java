...
import com.meemaw.auth.sso.openid.google.OpenIdGoogleClient;
...
@QuarkusTest
@Tag("integration")
public class OpenIdGoogleResourceImplTest {

  @Inject OpenIdGoogleClient openIdGoogleClient;
  @Inject OpenIdGoogleService openIdGoogleService;
  ...
  @TestHTTPResource(OpenIdGoogleResource.PATH + "/" + OpenIdResource.CALLBACK_PATH)
  ...
  public void google_sign_in_should_fail_when_no_dest() {
    given()
        .when()
        .get(OpenIdGoogleResource.PATH + "/signin")
        .then()
        .statusCode(400)
        .body(
            sameJson(
  ...
  public void google_oauth2callback__should_set_session_id___when_succeed_with_fresh_sign_up() {
    QuarkusMock.installMockForInstance(
        new MockedOpenIdGoogleClient("marko.novak+social@gmail.com"), openIdGoogleClient);
    String state = openIdGoogleService.secureState("https://www.insight.io/my_path");
  ...
  public void google_oauth2callback__should_set_verification_cookie__when_user_with_tfa_succeed()
    ...
    QuarkusMock.installMockForInstance(new MockedOpenIdGoogleClient(email), openIdGoogleClient);
    String state = openIdGoogleService.secureState("https://www.insight.io/my_path");
  ...
  private static class MockedOpenIdGoogleClient extends OpenIdGoogleClient {

    private final String email;

    public MockedOpenIdGoogleClient(String email) {
