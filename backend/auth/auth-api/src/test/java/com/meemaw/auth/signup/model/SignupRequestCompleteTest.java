...
public class SignupRequestCompleteTest {
  ...
  public void dtoJacksonSerialization() throws JsonProcessingException {
    ...
    SignupRequestCompleteDTO signupCompleteRequest =
        new SignupRequestCompleteDTO("test@gmail.com", "ORG", token, "superPassword");
    ...
    SignupRequestCompleteDTO deserialized =
        JacksonMapper.get().readValue(payload, SignupRequestCompleteDTO.class);
