...
public class PasswordResetRequestTest {
  ...
  public void dtoJacksonSerialization() throws JsonProcessingException {
    ...
    PasswordResetRequestDTO signupCompleteRequest = new PasswordResetRequestDTO(
        "test@gmail.com",
        "ORG",
        token, "superPassword");
    ...
    PasswordResetRequestDTO deserialized = JacksonMapper.get()
        .readValue(payload, PasswordResetRequestDTO.class);
