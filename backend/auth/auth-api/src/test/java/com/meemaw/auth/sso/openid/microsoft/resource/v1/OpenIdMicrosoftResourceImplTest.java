...
import com.meemaw.auth.sso.openid.microsoft.OpenIdMicrosoftClient;
...
@QuarkusTest
@Tag("integration")
public class OpenIdMicrosoftResourceImplTest {

  @Inject AppConfig appConfig;
  @Inject MockMailbox mailbox;
  @Inject ObjectMapper objectMapper;
  @Inject OpenIdMicrosoftClient openIdClient;
  @Inject OpenIdMicrosoftService openIdService;
  @Inject UserDatasource userDatasource;
  @Inject TfaTotpSetupDatasource tfaTotpSetupDatasource;

  @TestHTTPResource(OpenIdMicrosoftResource.PATH + "/" + OpenIdResource.CALLBACK_PATH)
  URI oauth2CallbackUri;

  @TestHTTPResource(OpenIdMicrosoftResource.PATH + "/signin")
  URI signInUri;
  ...
  public void oauth2callback__should_set_verification_cookie__when_user_with_tfa_succeed()
    ...
    QuarkusMock.installMockForInstance(new MockedOpenIdMicrosoftClient(email), openIdClient);
  ...
  private static class MockedOpenIdMicrosoftClient extends OpenIdMicrosoftClient {

    private final String email;

    public MockedOpenIdMicrosoftClient(String email) {
