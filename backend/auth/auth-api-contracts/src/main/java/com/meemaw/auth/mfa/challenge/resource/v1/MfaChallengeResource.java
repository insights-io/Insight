...
public interface MfaChallengeResource {
  ...
  @APIResponses(
      value = {
        @APIResponse(
            ...
            content =
                @Content(
                    schema = @Schema(implementation = MfaMethodCollectionDataResponse.class),
                    mediaType = MediaType.APPLICATION_JSON)),
        @APIResponse(
            responseCode = "404",
  ...
  class MfaMethodCollectionDataResponse extends RebrowseApiDataResponse<List<MfaMethod>> {}
