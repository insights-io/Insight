...
public class PostgresTestContainer extends PostgreSQLContainer<PostgresTestContainer>
  ...
  private void createTestUserPassword() {
    System.out.printf(
        "[TEST-SETUP]: Creating test password for \"%s\"%n", GlobalTestData.REBROWSE_ADMIN_EMAIL);
    ...
    Query query =
        SQLContext.POSTGRES
            ...
            .values(
                GlobalTestData.REBROWSE_ADMIN_ID,
                BCrypt.hashpw(GlobalTestData.REBROWSE_ADMIN_PASSWORD, BCrypt.gensalt(4)));
