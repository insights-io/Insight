...
public class UserData {
  ...
  public static CompletionStage<UserData> retrieve(RequestOptions requestOptions) {
    return ApiResource.get("/v1/sso/session/userdata", UserData.class, requestOptions);
  }
  ...
  public static CompletionStage<UserData> retrieve(
    ...
    return ApiResource.get(
        String.format("/v1/sso/session/%s/userdata", sessionId), UserData.class, requestOptions);
  }
}
