...
import static com.rebrowse.session.sessions.datasource.sql.SqlSessionTable.FIELD_MAPPINGS;
import static com.rebrowse.session.sessions.datasource.sql.SqlSessionTable.ID;
import static com.rebrowse.session.sessions.datasource.sql.SqlSessionTable.INSERT_FIELDS;
import static com.rebrowse.session.sessions.datasource.sql.SqlSessionTable.LOCATION;
