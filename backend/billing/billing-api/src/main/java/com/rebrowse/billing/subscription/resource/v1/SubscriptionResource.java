  ...
  @APIResponses(
      value = {
        @APIResponse(
            ...
            content =
                @Content(
                    schema = @Schema(implementation = SubscriptionDataResponse.class),
  ...
  @APIResponses(
      value = {
        @APIResponse(
            ...
            content =
                @Content(
                    schema = @Schema(implementation = SubscriptionCreatedDataResponse.class),
                    mediaType = MediaType.APPLICATION_JSON)),
        @APIResponse(
            responseCode = "400",
  ...
  @APIResponses(
      value = {
        @APIResponse(
            ...
            content =
                @Content(
                    schema = @Schema(implementation = SubscriptionCollectionResponse.class),
                    mediaType = MediaType.APPLICATION_JSON)),
        @APIResponse(
            responseCode = "401",
            description = "Unauthorized",
  ...
  @APIResponses(
      value = {
        @APIResponse(
            ...
            content =
                @Content(
                    schema = @Schema(implementation = ActivePlanDataResponse.class),
                    mediaType = MediaType.APPLICATION_JSON)),
        @APIResponse(
            responseCode = "401",
            description = "Unauthorized",
